import {
  require_react_dom
} from "./chunk-VEYZKKLA.js";
import {
  require_jsx_runtime
} from "./chunk-MOBJNRDH.js";
import {
  composeRefs,
  createSlot,
  createSlottable,
  dist_exports,
  useComposedRefs
} from "./chunk-AJFFVEFN.js";
import {
  require_react
} from "./chunk-BNBWFXBL.js";
import {
  __export,
  __privateAdd,
  __privateGet,
...
function CheckboxProvider(props) {
  ...
  const [control, setControl] = React39.useState(null);
...
var CheckboxTrigger = React39.forwardRef(
...
var CheckboxBubbleInput = React39.forwardRef(
...
var Popper = (props) => {
  ...
  const [placementState, setPlacementState] = React42.useState(void 0);
...
var PopperAnchor = React42.forwardRef(
  (props, forwardedRef) => {
    ...
    const callbackRef = React42.useCallback(
      (node) => {
        ref.current = node;
        if (node) {
          onAnchorChange(node);
...
var NavigationMenuViewportImpl = React51.forwardRef((props, forwardedRef) => {
  ...
  const [size4, setSize] = React51.useState(null);
...
var OneTimePasswordField = React52.forwardRef(
  function OneTimePasswordFieldImpl({
    ...
    const latestValueRef = React52.useRef(value);
    latestValueRef.current = value;
    const dispatch = React52.useCallback(
      (action) => {
...
function RadioProvider(props) {
  ...
  const [control, setControl] = React56.useState(null);
  const [bubbleInput, setBubbleInput] = React56.useState(null);
...
var RadioTrigger = React56.forwardRef(
...
var RadioBubbleInput = React56.forwardRef(
  ({ __scopeRadio, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React56.useRef(checked);
    return (0, import_jsx_runtime33.jsx)(
      Primitive.input,
      {
        type: "radio",
...
function SelectProvider(props) {
  ...
  const handleNativeOptionAdd = React58.useCallback((option) => {
    setNativeOptionsSet((prev) => new Set(prev).add(option));
  }, []);
  const handleNativeOptionRemove = React58.useCallback((option) => {
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime36.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime36.jsx)(React58.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }
);
...
var SelectContentFragment = React58.forwardRef((props, forwardedRef) => {
...
var SelectContentImpl = React58.forwardRef(
  (props, forwardedRef) => {
    ...
    const handleItemLeave = React58.useCallback(() => content == null ? void 0 : content.focus(), [content]);
...
var Separator3 = React59.forwardRef((props, forwardedRef) => {
...
var Slider = React60.forwardRef(
  (props, forwardedRef) => {
    ...
    const isKeyboardInteractionRef = React60.useRef(false);
...
var SliderThumbTrigger = React60.forwardRef(
  (props, forwardedRef) => {
...
function SwitchProvider(props) {
  ...
  const [bubbleInput, setBubbleInput] = React61.useState(null);
...
var SwitchTrigger = React61.forwardRef(
...
var SwitchBubbleInput = React61.forwardRef(
  ({ __scopeSwitch, ...props }, forwardedRef) => {
    ...
    const defaultCheckedRef = React61.useRef(checked);
    return (0, import_jsx_runtime39.jsx)(
      Primitive.input,
      {
        type: "checkbox",
...
var ToggleGroup = React65.forwardRef((props, forwardedRef) => {
...
var ToggleGroupImplSingle = React65.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  return (0, import_jsx_runtime43.jsx)(
    ToggleGroupValueProvider,
    {
      ...
      type: "single",
      value: React65.useMemo(() => value ? [value] : [], [value]),
      onItemActivate: setValue,
      onItemDeactivate: React65.useCallback(() => setValue(""), [setValue]),
      children: (0, import_jsx_runtime43.jsx)(ToggleGroupImpl, { ...toggleGroupSingleProps, ref: forwardedRef })
    }
  );
});
var ToggleGroupImplMultiple = React65.forwardRef((props, forwardedRef) => {
  const {
    value: valueProp,
    defaultValue,
    onValueChange = () => {
  ...
  const handleButtonActivate = React65.useCallback(
    (itemValue) => setValue((prevValue = []) => [...prevValue, itemValue]),
    [setValue]
  );
  const handleButtonDeactivate = React65.useCallback(
    (itemValue) => setValue((prevValue = []) => prevValue.filter((value2) => value2 !== itemValue)),
    [setValue]
  );
  return (0, import_jsx_runtime43.jsx)(
...
var ToggleGroupImpl = React65.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeToggleGroup,
      disabled = false,
...
var ToggleGroupItem = React65.forwardRef(
  (props, forwardedRef) => {
...
var ToggleGroupItemImpl = React65.forwardRef(
  (props, forwardedRef) => {
