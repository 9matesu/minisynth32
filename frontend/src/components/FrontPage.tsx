export function FrontPage({ onNavigate }: { onNavigate: (view: 'synth' | 'tutorial') => void }) {
  return (
    <div className="front-page">
      <div className="front-page__container">
        <div className="front-page__header">
          <h1 className="front-page__title">minisynth32</h1>
          <p className="front-page__subtitle">1 OSC · Shared ADSR · Filter</p>
        </div>

        <div className="front-page__description">
          <p>Bem-vindo ao minisynth32, um sintetizador digital simplificado para explorar síntese sonora.</p>
        </div>
